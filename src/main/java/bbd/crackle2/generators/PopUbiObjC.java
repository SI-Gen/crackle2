...
public class PopUbiObjC extends Generator
{
  ...
  private static void generateStructs(Module module, String output, PrintWriter outLog)
  {
    try
    {
      outLog.println("Generating File: " + output + module.name + "Structs.h");
      ...
      outLog.println("Generating File: " + output + module.name + "Structs.m");
  ...
  private static void generateClasses(Module module, String output, PrintWriter outLog)
  {
    try
    {
      outLog.println("Generating File: " + output + module.name + ".h");
      ...
      outLog.println("Generating File: " + output + module.name + ".m");
