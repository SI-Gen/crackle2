...
public class PopUbiPython extends Generator
{
  ...
  */
  private static void generateStructs(Module module, String output, PrintWriter outLog)
  {
    ...
    try
    {
      ...
      String outFilePath = output + sourceName + ".py";
      outLog.println("Generating File: " + outFilePath);
      ...
      try
      {
        ...
        outData.println("# Generated by Crackle.PopUbiPython.java - generateStructs.");
  ...
  */
  private static void generateStubs(Module module, String output, PrintWriter outLog)
  {
    try
    {
      outLog.println("Generating File: " + output + module.name.toUpperCase() + "_CODE.py");
  ...
  private static String assertof(PythonArgs arg)
  {
    ...
    switch (arg.field.type.typeof)
    {
      ...
      case Type.INT:
        ...
        break;
      case Type.LONG:
        return "if not isinstance(" + arg.name + ", int): raise AssertionError, '%s is not instance of int' % ('" + arg.name + "')";
      case Type.FLOAT:
      case Type.DOUBLE:
        x = "float";
        break;
