...
public class PopUbiServer extends Generator
{
  ...
  private static void setPragmas(Module module)
  {
    ...
    for (int i = 0; i < module.pragmas.size(); i++)
    {
      ...
      if (pragma.trim().equalsIgnoreCase("AlignForSUN"))
        alignForSun = true;
    }
  }
  ...
  */
  public static void main(String args[])
  {
    try
    {
      ...
      {
        System.out.println(args[i]+": Generate ... ");
  ...
  */
  ...
  {
    errLog = outLog;
    System.out.println("Generating " + module.name);
    setPragmas(module);
  ...
  private static void generateCTablesHeader(Module module, String output, PrintWriter outLog)
  {
    try
    {
      String outFilePath = output + module.name.toLowerCase() + "tables.h";
      System.out.println("Generating File: " + outFilePath);
      OutputStream outFile = new FileOutputStream(outFilePath);
      PrintWriter outData = new PrintWriter(outFile);
      try
      {
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiServer.java - generateCTablesHeader.");
    ...
    {
      System.out.println("Generate Procs IO Error");
  ...
  private static void generateCTablesCode(Module module, String output, PrintWriter outLog)
  {
    try
    {
      System.out.println("Generating File: "+output+module.name.toLowerCase()+"tables.cpp");
      OutputStream outFile = new FileOutputStream(output+module.name.toLowerCase()+"tables.cpp");
      PrintWriter outData = new PrintWriter(outFile);
      try
      {
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiServer.java - generateCTablesCode.");
  ...
  */
  ...
  private static void generateCHeader(Module module, String output, PrintWriter outLog)
  {
    try
    {
      String outFilePath = output + module.name.toLowerCase() + ".h";
      System.out.println("Generating File: " + outFilePath);
      OutputStream outFile = new FileOutputStream(outFilePath);
      PrintWriter outData = new PrintWriter(outFile);
      try
      {
        ...
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiServer.java - generateCHeader.");
        ...
        for (int i = 0; i < module.prototypes.size(); i++)
        {
          ...
          if (prototype.codeType != Prototype.RPCCALL)
            continue;
          outData.println("  e" + module.name + " " + prototype.name + "(char *ip, char* &replyBody, int32 &inReplySize);");
        }
        outData.println("};");
        outData.println();
        outData.println("#endif");
  ...
  private static void generateEmbedHCode(Module module, String output, PrintWriter outLog)
  {
    try
    {
      ...
      //System.out.println("Generating File: " + output + modname + "embed.h");
      if (mainfile.exists())
        return;
  ...
  private static boolean generateEmbedCCode(Module module, String output, PrintWriter outLog)
  {
    ...
    {
      String modname = module.name.toLowerCase();
      System.out.println("Generating File: " + output + modname + "embed.cpp");
      System.out.println("Generating File: " + output + modname + "embed.h");
  ...
  private static boolean generatePyCCode(Module module, String output, PrintWriter outLog)
  {
    ...
    try
    {
      System.out.println("Generating File: "+output+module.name.toLowerCase()+"pycode.cpp");
      OutputStream outFile = new FileOutputStream(output+module.name.toLowerCase()+"pycode.cpp");
      PrintWriter outData = new PrintWriter(outFile);
      try
      {
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiServer.java - generatePyCCode.");
  ...
  private static void generatePyHCode(Module module, String output, PrintWriter outLog)
  {
    try
    {
      System.out.println("Generating File: " + output + module.name.toLowerCase() + "pycode.h");
  ...
  private static void generateCCode(Module module, String output, PrintWriter outLog)
  {
    try
    {
      System.out.println("Generating File: "+output+module.name.toLowerCase()+"impl.cpp");
      OutputStream outFile = new FileOutputStream(output+module.name.toLowerCase()+"impl.cpp");
      PrintWriter outData = new PrintWriter(outFile);
      try
      {
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiServer.java - generateCCode.");
        outData.println("#include \"machine.h\"");
        outData.println("#include \"ubixcept.h\"");
        outData.println();
  ...
  private static void generateReqIDTable(Module module, String output, PrintWriter outLog)
  {
    try
    {
      System.out.println("Generating File: "+output+module.name.toLowerCase()+"ReqID.txt");
  ...
  */
  private static void generateCMain(Module module, String output, PrintWriter outLog)
  {
    try
    {
      String outputFile = output + module.name.toLowerCase() + ".cpp";
      ...
      try
      {
        ...
        outData.println("// Generated by PopUbiServer.java - generateCMain");
        outData.println("#include \"machine.h\"");
        outData.println();
  ...
  */
  private static boolean generateCServer(Module module, String output, PrintWriter outLog)
  {
    ...
    try
    {
      System.out.println("Generating File: "+output+module.name.toLowerCase()+"server.cpp");
      OutputStream outFile = new FileOutputStream(output+module.name.toLowerCase()+"server.cpp");
      PrintWriter outData = new PrintWriter(outFile);
      try
      {
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiServer.java - generateCServer");
        outData.println("#include \"machine.h\"");
        outData.println("#include \"ubixcept.h\"");
        outData.println("#include <stdio.h>");
        outData.println("#include <stdlib.h>");
        ...
        outData.println("  char* replyBody = 0;");
        outData.println("  int32 replySize = 0;");
        for (int j = 0; j < module.pragmas.size(); j++)
        {
            String pragma = (String)module.pragmas.elementAt(j);
            int n = pragma.indexOf("PRESERVICECALL:");
            if (n < 0)
                continue;
            pragma = pragma.substring(n + 15).trim();

            outData.println("  if (!" + module.name + "->" + pragma + "())");
            String pragma1 = "";
            for (int i = 0; i < module.pragmas.size(); i++)
            {
                String temp = (String)module.pragmas.elementAt(i);
                n = temp.indexOf("PRESERVICECALLEXCEPTION:");
                if (n < 0)
                    continue;
                pragma1 = temp.substring(n + 24).trim();
                break;
            }
            if (!pragma1.isEmpty())
                outData.println("    throw TUbiException(e" + module.name + "::" + pragma1 + ", \"PreServiceCallFailure\", __FILE__, __LINE__);");
            else
                outData.println("    throw TUbiException(1742, \"PreServiceCallFailure\", __FILE__, __LINE__);");
            break;
        }
        ...
        for (int i = 0; i < module.prototypes.size(); i++)
        {
          ...
          outData.println("    IDL2_UBI_LOG((" + module.name + "->logFile->lprintf(eLogDebug, \"[%d] [%s]" + prototype.name + "[" + prototype.signature(true) + "]\", input->reqID, input->IpAddress)));");
          ...
          outData.println("    else");
          outData.println("      result = " + prototype.name + "(ip, replyBody, replySize);");
          outData.println("    IDL2_UBI_LOG((" + module.name + "->logFile->lprintf(eLogDebug, \"[result=%d][%d][%s] " + prototype.name + "[" + prototype.signature(true) + "]\", result, input->reqID, input->IpAddress)));");
        ...
        {
          String pragma = (String)module.pragmas.elementAt(j);
          int n = pragma.indexOf("POSTSERVICECALL:");
          if (n < 0)
            continue;
          pragma = pragma.substring(n + 16).trim();

          outData.println("  if (!" + module.name + "->" + pragma + "(result))");
          String pragma1 = "";
          for (int i = 0; i < module.pragmas.size(); i++)
          {
            String temp = (String)module.pragmas.elementAt(i);
            n = temp.indexOf("POSTSERVICECALLEXCEPTION:");
            if (n < 0)
              continue;
            pragma1 = temp.substring(n + 25).trim();
            break;
          }
          if (!pragma1.isEmpty())
            outData.println("    throw TUbiException(e" + module.name + "::" + pragma1 + ", \"PostServiceCallFailure\", __FILE__, __LINE__);");
          else
            outData.println("    throw TUbiException(1743, \"PostServiceCallFailure\", __FILE__, __LINE__);");
          break;
        }
  ...
  */
  ...
  {
    outData.println("e" + module.name + " T" + module.name + "Server::" + prototype.name + "(char *ip, char* &replyBody, int32 &inReplySize)");
    outData.println("{");
    outData.println("  e" + module.name + " resultCode = " + module.name.toUpperCase() + "_OK;");
    outData.println("  try");
    outData.println("  {");
    outData.println("    int32 recvSize = 0;");
    outData.println("    int32 replySize = 0;");
      ...
      || field.type.reference == Type.BYREFPTR)
      {
        if (input.hasSize() == false)
        {
          ...
          else if (field.type.typeof == Type.USERTYPE)
          {
            ...
            {
                outData.println("    " + field.type.name + "* " + field.name + " = (" + field.type.name + "*)ip;");
                if (addUp)
    ...
    if (hasOutput)
    {
      ...
      outData.println("    inReplySize = replySize;");
  ...
  */
  public static void generateCSwaps(Module module, Prototype prototype, Field field, Operation op, PrintWriter outData)
  {
    ...
    if (field.isStruct(module))
    {
      ...
      errLog.println("Warning: "+prototype.name+" "+field.name+" is of UserType and may require swaps.");
  }
