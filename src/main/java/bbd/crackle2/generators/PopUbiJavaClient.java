...
public class PopUbiJavaClient extends Generator
{
      ...
      PrintWriter outLog)
  {
    try
    {
      ...
      outLog.println("Generating File: " + output + module.name + "Structs.java");
      ...
      try
      {
        ...
        outData.println();
        outData.println("import bbd.crackle2.rdc.*;");
        outData.println();
  ...
  private static String getPackageName(Module module)
  {
    if (module.packageName.length() == 0)
      return "bbd.crackle2." + module.name.toLowerCase();
      ...
      PrintWriter outLog)
  {
    ...
    {
      String output = outputDir(module, stdOutput);
      outLog.println("Generating File: " + output + module.name + ".java");
      OutputStream outFile = new FileOutputStream(output + module.name
          + ".java");
      PrintWriter outData = new PrintWriter(outFile);
      try
