  ...
  */
  ...
  public static void generateCClient(Module module, String output, PrintWriter outLog)
  {
    try
    {
      ...
      try
      {
        ...
        outData.println("// Generated by Crackle.PopUbiPuffinModule.java - generateCClient.");
      ...
      try
      {
        ...
        outData.println("}");
        outData.println();
        outData.println("static void New" + module.name + "GetModule()");
        outData.println("{");
        ...
        outData.println("    }");
        outData.println("    " + module.name.toLowerCase() + " = new T" + module.name + "();");
        outData.println("    SingletonLogFile::Initialize(logfile, logLevel, display);");
        ...
        outData.println("}");
        outData.println();
        outData.println("static PyObject* _DO_" + module.name + "_NodeManager_Initialize(PyObject *self, PyObject *args)");
        outData.println("{");
        outData.println("	PyObject* connObj = NULL;");
        outData.println("	PyObject* logObj = NULL;");
        outData.println("	if (!PyArg_UnpackTuple(args, \"tup\", 1, 2, &connObj, &logObj))");
        outData.println("		return NULL;");
        outData.println();
        outData.println("	if (!PyCapsule_CheckExact(connObj))");
        outData.println("		return Py_BuildValue(\"si\", \"Connection value is not a Python Capsule\", -1);");
        outData.println();
        outData.println("	if (!PyCapsule_CheckExact(logObj))");
        outData.println("		return Py_BuildValue(\"si\", \"Logfile value is not a Python Capsule\", -1);");
        outData.println();
        outData.println("	TJConnector* dbConnection = (TJConnector*)PyCapsule_GetPointer(connObj, \"node_manager_db_connection_capsule\");");
        outData.println("	tLogFile* logfile = (tLogFile*)PyCapsule_GetPointer(logObj, \"node_manager_logfile_capsule\");");
        outData.println();
        outData.println("	if (!" + module.name.toLowerCase() + ")");
        outData.println("	{");
        outData.println("	    " + module.name.toLowerCase() + " = new T" + module.name + "();");
        outData.println("	    " + module.name.toLowerCase() + "->HostedInitialize(dbConnection, logfile, 0, 0);");
        outData.println("	    " + module.name.toLowerCase() + "->logFile->lprintf(eLogDebug, \"new T" + module.name + " Node Manager TJConnector() copy created\");");
        outData.println("	}");
        outData.println("	return Py_BuildValue(\"si\", \"OK\", 0);");
        outData.println("}");
        outData.println();
        outData.println("static PyObject* _" + module.name + "_NodeManager_Initialize(PyObject *self, PyObject *args)");
        outData.println("{");
        outData.println("	return _error_check(_DO_" + module.name + "_NodeManager_Initialize, self, args);");
        outData.println("}");
        outData.println();
        outData.println("static PyObject* _DO_" + module.name + "_NodeManager_InitializeCBInterface(PyObject *self, PyObject *args)");
        outData.println("{");
        outData.println("	PyObject* connObj = NULL;");
        outData.println("	if (!PyArg_UnpackTuple(args, \"tup\", 1, 1, &connObj))");
        outData.println("		return NULL;");
        outData.println();
        outData.println("	if (!PyCapsule_CheckExact(connObj))");
        outData.println("		return Py_BuildValue(\"si\", \"Connection value is not a Python Capsule\", -1);");
        ...
        outData.println("	if (" + module.name.toLowerCase() + ")");
        outData.println("	{");
        outData.println("	    " + module.name.toLowerCase() + "->HostedInitializeCBInterface(dbConnection);");
        outData.println("	    " + module.name.toLowerCase() + "->logFile->lprintf(eLogDebug, \"new T" + module.name + " Node Manager Extended Interface created\");");
        outData.println("	}");
        outData.println("	return Py_BuildValue(\"si\", \"OK\", 0);");
        outData.println("}");
        outData.println();
        outData.println("static PyObject* _" + module.name + "_NodeManager_InitializeCBInterface(PyObject *self, PyObject *args)");
        outData.println("{");
        outData.println("	return _error_check(_DO_" + module.name + "_NodeManager_InitializeCBInterface, self, args);");
        outData.println("}");
        outData.println();
        ...
        outData.println("}");
        outData.println();
        outData.println("static PyObject* _DO__new_" + module.name.toLowerCase() +"_instance__(PyObject *self, PyObject *args)");
        outData.println("{");
        outData.println("  New" + module.name + "GetModule();");
        outData.println("  return Py_BuildValue(\"si\", \"OK\", 0);");
        outData.println("}");
        outData.println();
        outData.println("static PyObject* __new_" + module.name.toLowerCase() +"_instance__(PyObject *self, PyObject *args)");
        outData.println("{");
        outData.println("  return _error_check(_DO__new_" + module.name.toLowerCase() +"_instance__, self, args);");
        outData.println("}");
        outData.println();
  ...
  public static void generatePyClient(Module module, String output, PrintWriter outLog)
  {
    try
    {
      ...
      outLog.println("Generating File: " + outname);
  ...
  public static void generateMethodsDef(Module module, PrintWriter outData)
  {
    ...
    outData.println(", { \"_" + module.name + "_NodeManager_Initialize\", _" + module.name + "_NodeManager_Initialize, METH_VARARGS }");
    outData.println(", { \"_" + module.name + "_NodeManager_InitializeCBInterface\", _" + module.name + "_NodeManager_InitializeCBInterface, METH_VARARGS }");
    outData.println(", { \"__new_" + module.name.toLowerCase() +"_instance__\", __new_" + module.name.toLowerCase() +"_instance__, METH_VARARGS }");
    outData.println(", { NULL, NULL, 0, NULL } /* Sentinel */");
    outData.println("};");
    outData.println("#if PY_VERSION_HEX >= 0x03000000");
    outData.println("static struct PyModuleDef " + module.name + "Module = {");
    outData.println("#if PY_VERSION_HEX >= 0x03020000");
    outData.println("    PyModuleDef_HEAD_INIT,");
    outData.println("#else");
    outData.println("    {");
    outData.println("        PyObject_HEAD_INIT(NULL)");
    outData.println("            NULL, /* m_init */");
    outData.println("        0,        /* m_index */");
    outData.println("        NULL,     /* m_copy */");
    outData.println("    },");
    outData.println("#endif");
    outData.println("    (char *)\"" + module.name.toLowerCase() + "Methods\",");
    outData.println("    NULL,");
    outData.println("    -1,");
    outData.println("    " + module.name.toLowerCase() + "Methods,");
    outData.println("    NULL,");
    outData.println("    NULL,");
    outData.println("    NULL,");
    outData.println("    NULL};");
    ...
    outData.println("PyInit_" + module.name.toLowerCase() + "Methods(void)");
    outData.println("{");
    outData.println("    return PyModule_Create(&" + module.name + "Module);");
    outData.println("}");
    outData.println("#else");
    outData.println("PyMODINIT_FUNC");
  ...
  public static void generatedMethodsHeader(Module module, PrintWriter outData) {
    outData.println("# This code was generated, do not modify it, modify it at source and regenerate it.");
    outData.println("# Generated by Crackle.PopUbiPuffinModule.java - generatedMethodsHeader.");
    ...
    outData.println();
    outData.println("def __init__(connectString, logfile=r'C:\\temp\\" + module.name + ".log'):");
    outData.println("    global __handle__");
    ...
    outData.println();
    outData.println("def new_" + module.name.toLowerCase() +"_instance():");
    outData.println("    " + module.name.toLowerCase() + "Methods.__new_" + module.name.toLowerCase() +"_instance__()");
    outData.println();
    ...
    outData.println("    if maybe is None:");
    ...
    outData.println("    if not isinstance(maybe, list):");
    outData.println("        if name not in maybe._name(): raise AssertionError('%s is not of type in %s' % (name, repr(maybe._name())))");
    outData.println("        return");
    ...
    outData.println("        if name not in rec._name(): raise AssertionError('%s is not of type in %s' % (name, repr(rec._name())))");
    outData.println();
    outData.println("ERR_INSTANCE_MSG = 'Param [%s] invalid type [%s] - is actually [%s]'");
    outData.println();
    outData.println("def get_class_name(obj_inst, full=True):");
    outData.println("    type_name = obj.__class__.__name__");
    outData.println("    if full:");
    outData.println("        module_name = obj.__class__.__module__");
    outData.println("        return '%s.%s' % (module_name, type_name)");
    outData.println("    else:");
    outData.println("        return type_name");
    outData.println();
    outData.println("def check_instance(obj, obj_type, field_name, is_list=False):");
    outData.println("    if isinstance(obj, obj_type):");
    outData.println("        return");
    outData.println();
    outData.println("    check_type = ' OR '.join([get_class_name(r, False) for r in obj_type])");
    outData.println();
    outData.println("    err_string = ERR_INSTANCE_MSG % (field_name, obj_type, get_class_name(obj))");
    outData.println();
    outData.println("    raise AssertionError(err_string)");
    outData.println();
  ...
  {
    generatedMethodsHeader(module, outData);
  ...
  private static void generateMethodCall(Module module, Prototype prototype, PrintWriter outData)
  {
    ...
    for (int i = 0; i < pythonArgs.size(); i++)
    {
      ...
      if (arg.isInput)
      {
      	outData.println("    @type " + arg.name + ": " + typeof(arg.field.type));
        inputList = inputList + arg.name + ":" + typeof(arg.field.type);
      ...
      if (arg.isOutput)
      {
        ...
        returnList += resultComma + typeof(arg.field.type);
        resultComma = ", ";
      }
    }
    if (returnList.length() > 0) 
    	outData.println("    @rtype " + (hasReturn == true ? returnType + ", " : "") + returnList);
    else {
    	outData.println("    @rtype " + (hasReturn == true ? returnType : ""));
    }
  ...
  private static String assertof(PythonArgsPM arg)
  {
    ...
    switch (arg.field.type.typeof)
    {
      ...
      case Type.INT:
        ...
        break;
      case Type.LONG:
      	return "check_instance(" + arg.name + ", (int), '" + arg.name + "')";
      case Type.FLOAT:
      case Type.DOUBLE:
        x = "float";
        break;
    ...
    return "check_instance(" + arg.name + ", " + x + ", '" + arg.name + "')";
  }
}
