...
public class PopUbiCSharp extends Generator
{
  ...
  private static void generateStructs(Module module, String output, PrintWriter outLog)
  {
    try
    {
      ...
      try
      {
        ...
        outData.println("// Generated by PopUbiCSharp.java - generateStructs.");
        outData.println();
        outData.println("using System;");
        //outData.println(makeAnyDBUsing(module));
        outData.println(makeJPortalUsing(module));
  ...
  private static String makeJPortalUsing(Module module) {
    return "using Bbd.Idl2.jportal;";
  }
  ...
  private static void generateInterfaces(Module module, String output, PrintWriter outLog)
  {
    try
    {
      ...
      {
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiCSharp.java - generateInterfaces.");
        outData.println();
        outData.println("using System;");
        //outData.println(makeAnyDBUsing(module));
        outData.println(makeJPortalUsing(module));
  ...
  private static void generateClasses(Module module, String output, PrintWriter outLog)
  {
    try
    {
      String outFilePath = output+module.name+".cs";
      ...
      {
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiCSharp.java - generateClasses.");
        outData.println();
        outData.println("using System;");
        ...
        outData.println("    public "+module.name+"(Header header, string host, string service, int timeOut, string defaultEncoding)");
        outData.println("    : base(header, host, service, timeOut, defaultEncoding)");
        outData.println("    {}");
  ...
  private static void generateProxies(Module module, String output, PrintWriter outLog)
  {
    try
    {
      ...
      {
        outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
        outData.println("// Generated by PopUbiCSharp.java - generateProxies.");
        outData.println();
        outData.println("using System;");
        outData.println("using Bbd.Idl2.Rpc;");
        //outData.println(makeAnyDBUsing(module));
        ...
        outData.println("    public "+module.name+"Proxy(Header header, string host, string service, int timeOut, string defaultEncoding)");
        outData.println("    {");
        outData.println("      server = new "+module.name+"(header, host, service, timeOut, defaultEncoding);");
        outData.println("    }");
  ...
  private static void generateInterfaces(Module module, PrintWriter outData)
  {
    ...
    {
      Prototype prototype = (Prototype) module.prototypes.elementAt(i);
      //System.out.println("TYPE: " + prototype.name + "=" + prototype.codeType);
      if (prototype.isRpcCall())// || prototype.isExtendedRpcCall())
    	  generateInterface(module, prototype, i, outData);
      else
    	  System.out.println("Ignoring prototype " + prototype.name);
    }
  }
